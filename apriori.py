...
def ord_comb(l,n): #get combinations
...
def generateItemset(itemArray,depth,data):
	x=ord_comb(itemArray,depth) #make combinations with the data
		...
		for index in indices2:
			...
			for line in temp_data:
				for item2 in part2:
					...
					if check2 == len(item2):
						line_count+=1
			#print part,"->",part2,check2,"/",len(temp_data) #part & part2 are lists.
...
def main():
	...
	#f=open("apriori2.txt","r")
	f=open("/root/Desktop/rand_apriori.txt","r")
	...
	print timeit.default_timer() - start_time, "seconds" #12-13 secs for 10.000 rows
